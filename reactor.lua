...
while true do
    ...
    monitorWriteTextRight(monitor, temperaturePercentage .. "%", 6, temperaturePercentageColor, colors.black)
    ...
    monitorDrawLine(monitor, 6, 14, fieldStrength, fieldStrengthPercentageColor)
